...
const ColorScheme _lightAdminColorScheme = ColorScheme(
  ...
  primary: Color.fromARGB(255, 134, 27, 48),
  ...
  secondaryContainer: Color.fromARGB(207, 137, 38, 61),
...
const ColorScheme _darkAdminColorScheme = ColorScheme(
  ...
  primary: Color(0xFFFFB4C1),
  onPrimary: Color(0xFF4C0010),
  primaryContainer: Color(0xFF8F1028),
  onPrimaryContainer: Color(0xFFFFD9DE),
  secondary: Color(0xFFE9C67A),
  onSecondary: Color(0xFF2F2300),
  secondaryContainer: Color(0xFF544000),
  onSecondaryContainer: Color(0xFFFFE9B8),
  tertiary: Color(0xFFFFB68B),
  onTertiary: Color(0xFF401400),
  tertiaryContainer: Color(0xFF652200),
  onTertiaryContainer: Color(0xFFFFDCC9),
  error: Color(0xFFFFB4AC),
  onError: Color(0xFF690004),
  errorContainer: Color(0xFF93000A),
  onErrorContainer: Color(0xFFFFDAD6),
  background: Color(0xFF100C0E),
  onBackground: Color(0xFFEEDFDA),
  surface: Color(0xFF181113),
  onSurface: Color(0xFFEEDFDA),
  surfaceVariant: Color(0xFF3F2E33),
  onSurfaceVariant: Color(0xFFDABFC5),
  outline: Color(0xFFA8848C),
  outlineVariant: Color(0xFF51363C),
  shadow: Colors.black,
  scrim: Colors.black,
  inverseSurface: Color(0xFFEEDFDA),
  onInverseSurface: Color(0xFF2D1E22),
  inversePrimary: Color(0xFFB22E46),
  surfaceTint: Color(0xFFFFB4C1),
);
